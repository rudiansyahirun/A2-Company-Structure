...
public class TechnicalLead {
    public TechnicalLead(String name) {
        /*
        Should create a new starting.TechnicalLead that is a Manager.
        The starting.TechnicalLead's base salary should be 1.3 times that of a
        starting.TechnicalEmployee. TechnicalLeads should have a default head count of 4
        */
    ...
    public boolean addReport(SoftwareEngineer e) {
        /*
        Should accept the reference to a starting.SoftwareEngineer object,
        and if the starting.TechnicalLead has head count left
        should add this employee to their list of direct reports.
        If the employee is successfully added to the starting.TechnicalLead's direct reports
    ...
    public boolean requestBonus(Employee e, double bonus) {
        ...
        the starting.BusinessLead supporting this starting.TechnicalLead.
    ...
    public String getTeamStatus() {
        ...
        It should return a string that is a combination of the starting.TechnicalLead's employee status
        followed by each of their direct employee's status on subsequent lines.
        If the starting.TechnicalLead has no reports it should print their employee status
        followed by the text " and no direct reports yet ".
        Example: "10 Kasey has 5 successful check ins and no direct reports yet".
        If the starting.TechnicalLead does have reports, it might look something like
