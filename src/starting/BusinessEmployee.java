...
public class BusinessEmployee {
    ...
    public double getBonusBudget() {
        ...
        How that budget is determined will depend on which type of Business starting.Employee
        */

    }
    public String employeeStatus() {
        /*
        Should return a String representation of this starting.BusinessEmployee
